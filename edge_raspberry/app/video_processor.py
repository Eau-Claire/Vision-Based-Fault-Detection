"""
Video processor for edge_raspberry runtime.

Handles video file processing with configurable frame sampling,
...
logger = get_logger("edge_video_processor")
